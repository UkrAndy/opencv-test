...
from workers.gesture_landmarks import gesture_getter
from workers.hands_landmarks import hands_getter
...
def main():
    ...
    while True:
        ...
        #  ####################################################################
        # key = cv.waitKey(10)
        # if camera_data_receiver_conn and camera_data_receiver_conn.poll(1):
        #     key, ret, image = camera_data_receiver_conn.recv()
        #     print('=== key, ret')
        #     print(key, ret)
            ...
            if is_selected:
                ...
                try:
                    ...
                    if pose_selection['pose_in_center'] is not None:
                        # print(pose_selection)

                        # image = pose_masker.apply_mask_yolo(image, pose_selection['pose_in_center'])
